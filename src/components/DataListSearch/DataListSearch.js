...
const countries = [
  ...
  { code: "NR", searchName: "Namibia", label: "Nauru", phone: "674" },
  { code: "NU", searchName: "Namibia", label: "Niue", phone: "683" },
  { code: "NZ", searchName: "Namibia", label: "New Zealand", phone: "64" },
  { code: "OM", searchName: "Namibia", label: "Oman", phone: "968" },
  { code: "PA", searchName: "Namibia", label: "Panama", phone: "507" },
  { code: "PE", searchName: "Namibia", label: "Peru", phone: "51" },
  {
    code: "PF",
    searchName: "Namibia",
  ...
  { code: "PH", searchName: "Namibia", label: "Philippines", phone: "63" },
  { code: "PK", searchName: "Namibia", label: "Pakistan", phone: "92" },
